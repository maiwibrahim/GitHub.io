...
Ibrahim, M. (2023). [Posthuman Subjectivity in BCI-VR Entanglement](/assets/pdf/posthuman-bci-vr.pdf){:target="_blank"}. In Veljko Dubljević & Allen Coin (Eds.), *Policy, Identity, and Neurotechnology: The Neuroethics of Brain-Computer Interfaces* (pp. 11-25). Springer.
...
Ibrahim, M. (2021). [Review of the book *Nihilism and Technology*, by N. Gertz](/assets/pdf/nihilism-review.pdf){:target="_blank"}. *Communication Design Quarterly*, 9(1), 32-34.
